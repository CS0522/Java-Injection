...
```js
// 1 + 2
// 测试 _memberAccess.* 与 denyMethodExecution 配对
// 测试 _memberAccess 中的属性单独出现 (不加 _memberAccess )
// 测试 "denyMethodExecution" 单独出现
// 测试 类 和 权限语句 的顺序
// normal
%{@sun.misc.Unsafe@getUnsafe(),
    #_memberAccess.allowStaticMethodAccess=true,
...
// 3
// 测试 _memberAccess, excludeProperties, @EMPTY_SET 配对和交换顺序
// high risk
